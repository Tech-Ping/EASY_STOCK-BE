...
INSERT IGNORE INTO QUIZ (id, question, answer_index, level) VALUES
                                                         ...
                                                         (6, '호가와 주문 잔량에 대한 설명: 호가는 무엇을 의미하나요?', 0, 'ONE'),
                                                         (7, '매도와 매수의 차이점은 무엇인가요?', 0, 'ONE'),
                                                         (8, '시장가 주문과 지정가 주문의 차이점은 무엇인가요?', 0, 'ONE');
...
INSERT IGNORE INTO QUIZ_OPTIONS (quiz_id, options) VALUES
                                                ...
                                                (6, '주식이 체결된 수량'),
                                                (6, '주식 시장에서 제공되는 총 잔량'),
                                                (7, '매도는 주식을 파는 것, 매수는 주식을 사는 것'),
                                                (7, '매수는 주식을 판매하는 것'),
                                                (7, '매도는 주식을 구매하는 것'),
                                                (8, '시장가는 즉시 체결, 지정가는 원하는 가격에서 체결'),
                                                (8, '지정가는 예약 주문 방식'),
                                                (8, '시장가는 즉시 체결 방식');
